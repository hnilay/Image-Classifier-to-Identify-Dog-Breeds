...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       #word_list_model_label = lower_model_label.split("_")
       #model_label = [elem.strip() for elem in word_list_model_label]
       ...
       # the extend function 
           ...
           #print("Else Kontrol: ",results_dic[key])
